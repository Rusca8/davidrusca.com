...
milmilionaris = [  # està en dòlars tot
    ...
    {"name": "Elon Musk", "wealth": 1_100_000_000_000, "short": "$1.1 T", "src": "wikipedia", "date": "2026/06"},
...
preus = {
    ...
    "Projectes Puntuals": {"desc": "Esdeveniments o projectes que podries pagar-te o que podries finançar de manera completament altruista.", "list": [
        ...
        {"icon": "📺", "desc": "Pepsi Cola (a la Superbowl de 2002)", "item": "La campanya publicitària de televisió més cara de la història", "price": 8_100_000, "date": "2002/03", "src": "Guinness World Records", "url": "https://www.guinnessworldrecords.com/world-records/most-expensive-advertising-campaign-on-television"},

...
from kubblive.routes import kubblive
...
app.register_blueprint(kubblive)
...
# Recopilar cambios por traducir:     $ pybabel extract -F babel.cfg -k _l -o messages.pot .
...
@app.route('/docentes/')
def docents():
    import llistat_recursos as doc
    return render_template("docentes.html", resource_list=doc.docents)
